...
You've decided to develop an application using a microservices architecture and have learned about how to design and integrate the microservices that'll make up your application. Now it's time to learn how to use your Docker skills to Dockerize a microservices-based application.
